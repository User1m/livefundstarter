...
function ois_option_label($data) {
	...
	echo '<tr id="' . $el_id . '" style="' . $style . '"';
	if (!empty($data['alternative']) && $data['alternative'] == 'yes') {
		echo ' class="alternate" ';
	}
	echo '>
			<td class="ois_label" style="font-family:\'Arial\';text-align:left !important;padding: 15px 5px 15 10px !important;text-shadow: #fff 0px 1px 0px !important;font-size:12px;' . $inner_style . '">
				' . $data['title'] . '
